...
- Progressive Skill Rotation is a placeholder — it's fully wired and selectable, but `generateMatchups()` just does random pairing with no actual skill-progression logic yet
