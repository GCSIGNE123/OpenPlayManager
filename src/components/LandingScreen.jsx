...
export default function LandingScreen({ onCreate, onAdmin, onDeveloper, onTemplates, onPlayerPortal, onLeagues, onMembership, joinCode, setJoinCode, handleJoin, joinError, joining }) {
  return (
