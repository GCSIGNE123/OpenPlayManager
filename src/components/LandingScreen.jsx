...
export default function LandingScreen({ onCreate, onAdmin, onDeveloper, onTemplates, onPlayerPortal, onLeagues, joinCode, setJoinCode, handleJoin, joinError, joining }) {
  return (
